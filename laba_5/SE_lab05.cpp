...
void main() {
	...
	try {
		...
		dictionary::Entry e1 = { 1,"Белодед" }, e2 = { 2,"Наркевич" },
			e3 = { 3,"Смелов" }, e4 = { 4,"Шиман" }, e5 = { 5,"Барковский" };
